...
export default function Allocation(){
  ...
  const [log,setLog] = useState<any[]>()
	...
	var allocateFn = useFetch<any,any>({
		url:`/api/web/allocation`,
		method:'POST',
		onError:(m) => {
			alert(m)
	...
	function handleSubmit(data:any){
		var limit = parseInt(data.batches.split("/")[1])
		var batchNumber = data.batches.split("/")[0]
		var quantity = parseInt(data.qty)
