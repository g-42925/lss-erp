...
export default function ProductPurchaseReportPage() {
  ...
  function toExcel() {
    ...
    const data = filtered.map(item => ({
      ...
      'Supplier / Vendor': item.supplierName,
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, 'Product Purchase')
    XLSX.writeFile(workbook, `product-purchase-${new Date().toISOString().slice(0,10)}.xlsx`)
  }
