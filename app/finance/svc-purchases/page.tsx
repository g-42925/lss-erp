...
export default function XPurchases() {
  ...
  async function submit(data: any) {
    ...
    addFn.fn('', body, (r) => {
      window.location.href = '/finance/svc-purchases'
    })
  }
            ...
            <form onSubmit={editForm.handleSubmit(_editSubmit)} className="h-92 relative flex flex-col gap-3">
              <div className="flex flex-col gap-3">
                <fieldset className="fieldset flex-1">
                  ...
                  <input {...editForm.register("description")} className="input w-full" />
                </fieldset>
                <fieldset className="fieldset flex-1">
          ...
          <div className="flex flex-col ">
            ...
            <form onSubmit={orderForm.handleSubmit(orderSubmit)} className="flex flex-col gap-3 pb-4">
              ...
              <fieldset className="fieldset hidden">
                ...
                <input className="input w-full" defaultValue={0} {...orderForm.register("payAmount")} type="text" />
              </fieldset>
              <fieldset className="fieldset">
