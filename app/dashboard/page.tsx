        ...
        {data && !loading && (
          <>
            ...
            <div className="rounded-2xl bg-gradient-to-r from-slate-800 via-slate-700 to-slate-800 text-white p-5 flex flex-wrap items-center gap-6">
              <div>
                <p className="text-white/50 text-xs font-bold uppercase tracking-widest">Pendapatan Bulan Ini</p>
                <p className="text-3xl font-extrabold">{data.revenueThisMonth.toLocaleString("id-ID")}</p>
              </div>
              <div className="w-px h-10 bg-white/20 hidden sm:block" />
              <div>
                <p className="text-white/50 text-xs font-bold uppercase tracking-widest">Order Bulan Ini</p>
                <p className="text-3xl font-extrabold">{data.orderCountThisMonth}</p>
              </div>
              <div className="w-px h-10 bg-white/20 hidden sm:block" />
              <div>
              ...
              <div className="w-px h-10 bg-white/20 hidden sm:block" />
              <div>
                <p className="text-white/50 text-xs font-bold uppercase tracking-widest">Orderan Hari Ini</p>
            ...
            <div>
              <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <KpiCard
                  ...
                  value={Math.round(data.totalRevenue).toLocaleString("id-ID")}
                  ...
                  linkHref="/sales/p-invoice"
                />
                <KpiCard
                  label="Pengeluaran"
                  change={-data.purchaseChange}
                  value={data.totalExpense.toLocaleString("id-ID")}
                ...
                <KpiCard
                  label="Piutang"
                  value={Math.round(data.outstandingReceivable).toLocaleString("id-ID")}
