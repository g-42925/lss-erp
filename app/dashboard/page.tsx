          ...
          <>
            ...
            <div className="rounded-2xl bg-gradient-to-r from-slate-800 via-slate-700 to-slate-800 text-white p-5 flex flex-wrap items-center gap-6">
              <div>
                ...
                <p className="text-3xl font-extrabold">{SHORT_IDR(data.todayRevenue)}</p>
              </div>
            ...
            <div>
              <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <KpiCard
                  label="Piutang"
                  value={SHORT_IDR(data.outstandingReceivable)}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
              {[
                ...
                { label: "Total Purchase", value: data.totalPurchase, icon: "🧑‍💼", href: "/purchases/requisition" },
                { label: "Hutang", value: SHORT_IDR(data.totalDebt), icon: "💳", href: "/finance/debt" },
